                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="<?= base_url('assets/img/profile/') . $user['img']; ?>" alt="Admin" class="rounded-circle" width="150">
                            <div class="mt-3">
                                <h4><?= $user['nama']; ?></h4>
                ...
                <div class="card mt-3">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <a href="https://www.linkedin.com/in/m-fajri-bryan-pratama-17bb6520a/" class="btn btn-outline-primary">M Fajri Bryan Pratama</a>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <a href="https://www.instagram.com/fajribryanp/" class="btn btn-outline-primary">fajribryanp</a>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6>
                            ...
                            <a href="https://wa.me/081218227004" class="btn btn-outline-primary">081218227004</a>
                        </li>
                    </ul>
                </div>
            </div>
