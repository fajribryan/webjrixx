                                    ...
                                    <?php foreach ($inisiatif as $row) : ?>
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <a href="<?= base_url(); ?>erdcontroller/deleteinisiatif/<?= $row['id_inisiatif']; ?>" class="btn btn-danger" onclick="return confirm('Yakin Data Akan Dihapus');" data-toggle="tooltip" data-placement="bottom" title="Hapus Inisiatif" class="btn btn-danger">
